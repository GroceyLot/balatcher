...
So it's an extremely simple balatro patcher made in 145 lines of python, clone this repo, run the main.py (no requirements) and then run build/BalatroMod.exe (all necessary DLLs and the license.txt are copied to build). 
It also removes all connection to steam and changes the save folder.
