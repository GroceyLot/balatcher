...
{
    // Convert to UV coords (0-1) and center them, no pixelation
    MY_HIGHP_OR_MEDIUMP vec2 uv = (screen_coords.xy - 0.5 * love_ScreenSize.xy) / length(love_ScreenSize.xy) - vec2(0.12, 0.);
